  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <Card className="glass-card border border-border flex flex-col justify-between">
        <CardHeader>
          <CardTitle className="text-lg font-bold text-white">Emission Categories</CardTitle>
          <CardDescription className="text-muted-foreground text-xs font-light">Annual carbon footprint split in kg CO2e</CardDescription>
        </CardHeader>
      ...
      <Card className="glass-card border border-border flex flex-col justify-between">
        <CardHeader>
          <CardTitle className="text-lg font-bold text-white">Historical Progress</CardTitle>
          <CardDescription className="text-muted-foreground text-xs font-light">Carbon emission reductions over time</CardDescription>
        </CardHeader>
